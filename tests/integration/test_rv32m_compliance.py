"""RV32M compliance tests against riscv-tests suite.

Runs all rv32um-p-* test binaries from the official RISC-V test suite.
...
# Collect all rv32um-p-* test binaries
_RV32UM_TESTS = sorted(FIXTURES.glob("rv32um-p-*"))
...
def test_rv32um(elf_path: pathlib.Path) -> None:
    """Run a single rv32um compliance test."""
